...
object TagMapper {
    ...
    /*fun fromString(value: String): MediaTagEnum? {
        return when (value) {
            "Shounen" -> MediaTagEnum.SHOUNEN
            "Shoujo" -> MediaTagEnum.SHOUJO
            "Seinen" -> MediaTagEnum.SEINEN
            "Josei" -> MediaTagEnum.JOSEI
            "Kids" -> MediaTagEnum.KIDS
            "Urban Fantasy" -> MediaTagEnum.URBAN_FANTASY
            "Villainess" -> MediaTagEnum.VILLAINESS
            "School" -> MediaTagEnum.SCHOOL
            "Adult Cast" -> MediaTagEnum.ADULT_CAST
            "Detective" -> MediaTagEnum.DETECTIVE
            "Strategy Game" -> MediaTagEnum.STRATEGY_GAME
            "Visual Arts" -> MediaTagEnum.VISUAL_ARTS
            "Idols (Male)", "Idols (Female)" -> MediaTagEnum.IDOLS
            "Organized Crime" -> MediaTagEnum.ORGANIZED_CRIME
            "Delinquents" -> MediaTagEnum.DELINQUENTS
            "Reverse Harem" -> MediaTagEnum.REVERSE_HAREM
            "Isekai" -> MediaTagEnum.ISEKAI
            "Educational" -> MediaTagEnum.EDUCATIONAL
            "Childcare" -> MediaTagEnum.CHILDCARE
            "Parody" -> MediaTagEnum.PARODY
            "Performing Arts" -> MediaTagEnum.PERFORMING_ARTS
            "Video Game" -> MediaTagEnum.VIDEO_GAME
            "Pets" -> MediaTagEnum.PETS
            "Mahou Shoujo" -> MediaTagEnum.MAHOU_SHOUJO
            "Magical Sex Shift" -> MediaTagEnum.MAGICAL_SEX_SHIFT
            "Space" -> MediaTagEnum.SPACE
            "Anthropomorphic" -> MediaTagEnum.ANTHROPOMORPHIC
            "Team Sports" -> MediaTagEnum.TEAM_SPORTS
            "Love Polygon" -> MediaTagEnum.LOVE_POLYGON
            "Super Power" -> MediaTagEnum.SUPER_POWER
            "Military" -> MediaTagEnum.MILITARY
            "Vampire" -> MediaTagEnum.VAMPIRE
            "Psychological" -> MediaTagEnum.PSYCHOLOGICAL
            "Survival" -> MediaTagEnum.SURVIVAL
            "Reincarnation" -> MediaTagEnum.REINCARNATION
            "Crossdressing" -> MediaTagEnum.CROSSDRESSING
            "CGDCT" -> MediaTagEnum.CGDCT
            "Medical" -> MediaTagEnum.MEDICAL
            "Harem" -> MediaTagEnum.HAREM
            "Samurai" -> MediaTagEnum.SAMURAI
            "Historical" -> MediaTagEnum.HISTORICAL
            "Otaku Culture" -> MediaTagEnum.OTAKU_CULTURE
            "Time Travel" -> MediaTagEnum.TIME_TRAVEL
            "Love Status Quo" -> MediaTagEnum.LOVE_STATUS_QUO
            "Racing" -> MediaTagEnum.RACING
            "Showbiz" -> MediaTagEnum.SHOWBIZ
            "Award Winning" -> MediaTagEnum.AWARD_WINNING
            "Gore" -> MediaTagEnum.GORE
            "Workplace" -> MediaTagEnum.WORKPLACE
            "Iyashikei" -> MediaTagEnum.IYASHIKEI
            "Music" -> MediaTagEnum.MUSIC
            "Gag Humor" -> MediaTagEnum.GAG_HUMOR
            "Martial Arts" -> MediaTagEnum.MARTIAL_ARTS
            "High Stakes Game" -> MediaTagEnum.HIGH_STAKES_GAME
            "Mecha" -> MediaTagEnum.MECHA
            "Mythology" -> MediaTagEnum.MYTHOLOGY
            "Combat Sports" -> MediaTagEnum.COMBAT_SPORTS
            "Yaoi" -> MediaTagEnum.YAOI
            "Yuri" -> MediaTagEnum.YURI
            "Boys Love" -> MediaTagEnum.BOYS_LOVE
            "Girls Love" -> MediaTagEnum.GIRLS_LOVE
            else -> null
        }
    }*/
}