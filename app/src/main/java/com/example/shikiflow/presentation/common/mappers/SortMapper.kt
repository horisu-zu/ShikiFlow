...
object SortMapper {
    fun SortType.displayValue(): Int {
        return when(this) {
            MediaSort.Common.SCORE, UserRateType.SCORE, ReviewType.SCORE -> R.string.ongoing_browse_mode_score
            ...
            StaffType.ID, UserRateType.ID, CharacterType.ID, ReviewType.ID -> R.string.sort_type_id
            ...
            ThreadType.CREATED_AT, ReviewType.CREATED_AT -> R.string.sort_type_created_at
            ...
            UserRateType.UPDATED_AT, ReviewType.UPDATED_AT -> R.string.sort_type_updated_at
            UserRateType.PROGRESS -> R.string.sort_type_progress
            ReviewType.RATING -> R.string.review_type_rating
        }
    }
